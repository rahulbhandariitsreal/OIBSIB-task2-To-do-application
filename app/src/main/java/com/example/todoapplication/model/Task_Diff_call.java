...
public class Task_Diff_call extends DiffUtil.Callback {
    ...
    ArrayList<Task_Holder> oldTaskList;
    ArrayList<Task_Holder> newTaskList;

    public Task_Diff_call(ArrayList<Task_Holder> oldTaskList, ArrayList<Task_Holder> newTaskList)  {
